    ...
    <div className={darkMode === true ? "DarkMode" : "LightMode"}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/dashboard/vehicle" element={<GetVehicle />} />
          <Route
            path="/admin/dashboard/vehicle/create"
            element={<AdminVehicle />}
          />
          <Route
            path="/admin/dashboard/vehicles/:id"
            element={<EditVehicleItem />}
          />
          <Route path="/admin/dashboard/user" element={<GetUser />} />
          <Route path="/admin/dashboard/user/create" element={<AdminUser />} />
          <Route path="/admin/dashboard/users/:id" element={<EditUserItem />} />
          ...
          <Route path="/vehicles/payment/:id/redirect" element={<Redirect />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
